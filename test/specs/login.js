...
describe('Login Positive Tests', () => {
    ...
    it('should not login with locked credentials', async () => {
        ...
        expect(await LoginPage.lockedMessage.getText()).toEqual('Epic sadface: Sorry, this user has been locked out.')
    });
    ...
    it('incorect thumbnail image is displayed after login with problem credentials', async () => {
        ...
        expect(await LoginPage.imageLocation.getAttribute('src')).toEqual(ImageSource.backpack)
    });
...
describe("Login Negative Tests",  () => {
    it('should not login with no username and password', async () => {
        ...
        expect(await LoginPage.lockedMessage.getText()).toEqual('Epic sadface: Username is required')
    });
    ...
    it('should not login with no password', async () => {
        ...
        expect(await LoginPage.lockedMessage.getText()).toEqual('Epic sadface: Password is required')
    });
    ...
    it('should not login with wrong password', async () => {
        ...
        expect(await LoginPage.lockedMessage.getText()).toEqual('Epic sadface: Username and password do not match any user in this service')
    });
